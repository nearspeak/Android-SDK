 ...
 */
public class WSR_ShowTagByNearSpeakID extends AsyncTask<String, Integer, TagModel> {

    public final static String CLASSNAME = "WSRShowTagByNearSpeakID";
    static IWSRShowTagListener mListener = null;

    public WSR_ShowTagByNearSpeakID(IWSRShowTagListener listener) {
        mListener = listener;
    }
    ...
    protected TagModel doInBackground(String... _request) {
        ...
        try {
            ...
            String url = Constants.URL_CORESERVER + Constants.REQUEST_GETTEXT_BY_NEARSPEAKID;
            url += "?id=" + _request[0] + "&lang=" + _request[1];
